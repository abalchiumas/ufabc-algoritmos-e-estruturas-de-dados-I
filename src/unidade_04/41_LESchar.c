...
Lista *criaListaVazia (const int tamanho) {
	...
	lista->itens = malloc(tamanho * sizeof(char));
...
int busca(Lista *lista, const char item) {
...
void inserir (Lista *lista, const char item) {
...
void remover (Lista *lista, const char item) {
